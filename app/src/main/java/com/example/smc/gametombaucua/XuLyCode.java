...
public class XuLyCode extends Activity {
    ...
    Callback callback = new Callback() {
        ...
        public boolean handleMessage(Message msg) {
            ...
            for (int i = 0; i < gtDatCuoc.length; i++) {
                ...
                Log.d("TienThuong" , "" +giaTriXiNgau1+""+giaTriXiNgau2+""+giaTriXiNgau3 + "tienThuong"+ "" + tienThuong);
            }
            if(tienThuong > 0){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xu_ly_code);
